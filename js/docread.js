        ...
        web3.eth.getBlockNumber(function (error, blocknr) {
            ...
            if (!error) {
                ...
                if (authoraddr !== "" && tag !== "") {
                    ...
                    tagSearchEvent = ethblogInstance.TagEvent({ author: authoraddr, taghash: taghash }, { fromBlock: startBlockNo, toBlock: 'latest' });
                ...
                if (authoraddr === "" && tag === "") {
                    ...
                    docSearchEvent = ethblogInstance.DocumentEvent({}, { fromBlock: startBlockNo, toBlock: 'latest' });
                ...
                // Search for documents written by authoraddr
                    ...
                    docSearchEvent = ethblogInstance.DocumentEvent({ author: authoraddr }, { fromBlock: startBlockNo, toBlock: 'latest' });
                    docSearchEvent.watch(function (error, result) {
                        if (!error) {
                ...
                // Search for ids of documents with tag identified by taghash
                    ...
                    tagSearchEvent = ethblogInstance.TagEvent({ taghash: taghash }, { fromBlock: startBlockNo, toBlock: 'latest' });
                    tagSearchEvent.watch(function (error, result) {
                        if (!error) {
...
function getDocs() {
    ...
    docSearchEvent = ethblogInstance.DocumentEvent({ docid: docidarray[rdcnt] }, { fromBlock: deployBlockNr, toBlock: 'latest' });
    docSearchEvent.watch(function (error, result) {
        if (!error) {
